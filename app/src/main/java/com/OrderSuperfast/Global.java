...
public class Global extends Application {
    ...
    protected void anadirImpresora(Impresora imp){
        listaImpresoras.add(imp);
    }

    protected ArrayList<Impresora> getListaImpresoras(){return this.listaImpresoras;}

    protected void removeListaImpresoras(){
        while (listaImpresoras.size()>0){
            listaImpresoras.remove(0);
        }
    }
