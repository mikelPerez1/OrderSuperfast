...
public class AdapterTakeAway2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    AdapterTakeAway2.ViewHolder2 holder2;
    int k = 0;
    ...
    public AdapterTakeAway2(List<TakeAwayPedido> itemList, String pEstado, Activity context,RecyclerView pRecycler,String pDispName, OnItemClickListener listener) {
    ...
    public void parpadeo(int pedido, boolean b) {
        ...
        for (int i = 0; i < Original.size(); i++) {
            TakeAwayPedido elemento = Original.get(i);
            System.out.println("parpadeo busqueda elemento "+elemento.getNumOrden()+ "con pedido num "+pedido);
            if (pedido == elemento.getNumOrden()) {
    ...
    public void filtrarPorTexto(String texto) {
        ...
        for (int i = 0; i < Original.size(); i++) {
            ...
            System.out.println("filtrar texto " + p.getNumOrden());
        ...
        mData.sort(new Comparator<TakeAwayPedido>() {
            @Override
            public int compare(TakeAwayPedido o1, TakeAwayPedido o2) {
    ...
    private boolean contieneTexto(TakeAwayPedido item, String texto) {
        String num = String.valueOf(item.getNumOrden()).toLowerCase();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindData(final TakeAwayPedido item, int position) {
            ...
            if(item.getEsPlaceHolder()){
                ...
                numOrden.setText(resources.getString(R.string.num_pedido) + " " + item.getNumOrden());
        ...
        private void setBarColor(TakeAwayPedido item) {
        ...
        private void textoPedidosMasDe8Horas(TakeAwayPedido item) {
            if (item.getDatosTakeAway().getTipo().equals("programado")) {
                Date d = new Date();
