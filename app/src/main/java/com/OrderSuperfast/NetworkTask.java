...
public class NetworkTask extends AsyncTask<Activity, Void, List<String>> {
    private Configuracion_impresoras context;
  ...
  */
    ...
    protected List<String> doInBackground(Activity... params) {
        ...
        context  =  (Configuracion_impresoras) params[0];
    ...
    private void peticionObtenerDatosDispositivo(String ip){
        String endpoint = "https://" + ip; // Endpoint de la solicitud
 ...
 */
    ...
    protected void onPostExecute(List<String> resultado) {
        ...
        context.cerrarDialogBuscar();
        //context.printDocument(resultado.get(0),url);
