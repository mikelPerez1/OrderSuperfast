...
public class GuardarFiltrarProductos extends AppCompatActivity {
    ...
    private int FLAG_MOSTRAR_PRODUCTOS = 1, FLAG_ESCONDER_PRODUCTOS = 2, FLAG_ESCONDER_OPCIONES = 3, FLAG_MODO_ACTUAL;
...
//            layoutOpcionesMostrar.setVisibility(View.GONE);
    ...
    private ConstraintLayout layoutElementosCarta, layoutVisualizacionProductos, layoutRecepcionPedidos, layoutTemporizador;
        ...
        pestañaPermitir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!onAnimationPestaña) {
                    ...
                    animacionCambiarPestaña(backAnimation, 1f, 0f, constraintAnimacion, pestañaPermitir, 1);
                }
        ...
        pestañaDenegar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!onAnimationPestaña) {
                    ...
                    animacionCambiarPestaña(backAnimation, 0f, 1f, constraintAnimacion, pestañaDenegar, 2);
                }
            }
        });
